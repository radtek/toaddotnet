...
namespace SyntaxHighlighter
{
	public class SyntaxRichTextBox : System.Windows.Forms.RichTextBox
	{
        ...
        private string m_strTablewords = "";
        private string m_strColumnwords = "";
		...
		private void ProcessLine()
		{
            ...
            // Process the tablewords
            ProcessRegex(m_strTablewords, Settings.TablewordColor);
            // Process the columnwords
            ProcessRegex(m_strColumnwords, Settings.ColumnwordColor);
			// Process numbers
        ...
        /// <summary>
        /// Compiles the tablewords as a regular expression.
        /// </summary>
        public void CompileTablewords()
        {
            for (int i = 0; i < Settings.Tablewords.Count; i++)
            {
                string strTableword = Settings.Tablewords[i];

                if (i == Settings.Tablewords.Count - 1)
                    m_strTablewords += "\\b" + strTableword + "\\b";
                else
                    m_strTablewords += "\\b" + strTableword + "\\b|";
            }
        }
        ...
        /// Compiles the tablewords as a regular expression.
        /// </summary>
        public void CompileColumnwords()
        {
            for (int i = 0; i < Settings.Columnwords.Count; i++)
            {
                string strColumnword = Settings.Columnwords[i];

                if (i == Settings.Columnwords.Count - 1)
                    m_strColumnwords += "\\b" + strColumnword + "\\b";
                else
                    m_strColumnwords += "\\b" + strColumnword + "\\b|";
            }
        }
	...
	public class SyntaxSettings
	{
        ...
        SyntaxList m_rgTablewords = new SyntaxList();
        SyntaxList m_rgColumnwords = new SyntaxList();
		string m_strComment = "";
        ...
        /// <summary>
        /// A list containing all Table.
        /// </summary>
        public List<string> Tablewords
        {
            get { return m_rgTablewords.m_rgList; }
        }
        /// <summary>
        /// A list containing all Table.
        /// </summary>
        public List<string> Columnwords
        {
            get { return m_rgColumnwords.m_rgList; }
        }
        ...
        /// <summary>
        /// The color of tablewords.
        /// </summary>
        public Color TablewordColor
        {
            get { return m_rgTablewords.m_color; }
            set { m_rgTablewords.m_color = value; }
        }

        /// <summary>
        /// The color of columnwords.
        /// </summary>
        public Color ColumnwordColor
        {
            get { return m_rgColumnwords.m_color; }
            set { m_rgColumnwords.m_color = value; }
        }
		/// <summary>
